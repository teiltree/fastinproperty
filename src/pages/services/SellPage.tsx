...
export default function SellPage() {
            ...
            <div className="relative h-[90vh] bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-90">
                    <div className="absolute bg-cover bg-center inset-0"
                         style={{
                             backgroundImage: `url('https://i.postimg.cc/wMT6KYd0/IMG-20251104-WA0039.jpg')`
                         }}>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        {/* Selling Online Section - WITH HANDS IMAGE */}
        <div className="mb-24">
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-xl overflow-hidden border border-blue-100">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    ...
                    {/* NEW: Hands Image Side */}
                    <div className="relative h-[400px] lg:h-auto order-1 lg:order-2 group">
                        <img
                            src="https://i.postimg.cc/mDSb62Ks/IMG_20251104_WA0040.jpg"
                            alt="Partnership and Trust"
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-blue-900/60 to-transparent"></div>
                        <div className="absolute bottom-0 left-0 right-0 p-6">
                            <div className="bg-gradient-to-r from-blue-900/90 to-blue-800/90 backdrop-blur-sm rounded-xl p-4 border-2 border-yellow-400">
                                <p className="text-yellow-400 text-xl font-bold text-center">Your Trusted Partner</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {/* NEW: Property Showcase Section - TWO HOUSE IMAGES */}
        <div className="mb-24">
            <div className="text-center mb-12">
                {/*<h2 className="text-4xl md:text-5xl font-bold text-blue-900 mb-4">*/}
                {/*    Properties We've Successfully Sold*/}
                {/*</h2>*/}
                <div className="w-24 h-1 bg-gradient-to-r from-yellow-500 to-yellow-600 mx-auto rounded-full mb-6"></div>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    From residential homes to commercial properties, we deliver results
                </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* House Image 1 */}
                <div className="group rounded-3xl overflow-hidden shadow-2xl border-4 border-blue-900/20 hover:border-yellow-400 transition-all duration-500">
                    <div className="relative h-[400px]">
                        <img
                            src="https://i.postimg.cc/Y0sBJ43s/IMG_20251104_WA0017.jpg"
                            alt="Sold Property - Residential Excellence"
                    ...
                    <div className="bg-gradient-to-r from-blue-900 to-blue-800 p-6">
                        <h3 className="text-yellow-400 text-2xl font-bold mb-2">Premium Residential Property</h3>
                        <p className="text-blue-100 text-sm">Sold through our efficient auction process</p>
                    </div>
                </div>
                ...
                <div className="group rounded-3xl overflow-hidden shadow-2xl border-4 border-blue-900/20 hover:border-yellow-400 transition-all duration-500">
                    <div className="relative h-[400px]">
                        <img
                            src="https://i.postimg.cc/CLRgbNMR/IMG_20251104_WA0020.jpg"
                            alt="Sold Property - Quality Home"
                            className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 via-blue-900/20 to-transparent"></div>
                        <div className="absolute top-4 left-4">
                    ...
                    <div className="bg-gradient-to-r from-blue-900 to-blue-800 p-6">
                        <h3 className="text-yellow-400 text-2xl font-bold mb-2">Quality Family Home</h3>
                        <p className="text-blue-100 text-sm">Another successful auction completion</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-blue-200 text-sm">
                ...
                <a href="mailto:info@fastinpropertyauctions.com" className="text-yellow-400 hover:text-yellow-300 font-semibold underline">
                    info@fastinpropertyauctions.com
                </a>
            </p>
        </div>
    </div>
