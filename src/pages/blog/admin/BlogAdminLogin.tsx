...
export default function BlogAdminLogin() {
  ...
  const from = (location.state as { from?: string } | null)?.from ?? '/blog/admin';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 md:p-10">
        ...
        <h1 className="text-2xl font-bold text-blue-900">Fastin Blog CMS</h1>
        <p className="text-gray-600 mt-2 text-sm">
          Sign in with your admin PIN to manage posts, categories, tags, and authors.
        </p>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          <Link to="/blog" className="text-blue-900 font-semibold hover:text-yellow-600">
            ← Back to blog
          </Link>
        </p>
      </div>
