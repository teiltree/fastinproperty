...
export default function HousesAdminSettings() {
  const { exportData, importData } = useHouses();
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-8">
        Backup, restore, and publish property listings for all visitors.
      </p>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 mb-8 flex gap-4">
        ...
        <div className="text-sm text-blue-900 space-y-2">
          ...
          <p>
            Changes you save in the CMS are stored in this browser. To show the same listings to all
            visitors after you deploy the site:
          </p>
          <ol className="list-decimal pl-5 space-y-1">
            <li>
              Click <strong>Export listings.json</strong> below.
            </li>
            <li>
              Place the file at{' '}
              <code className="bg-white px-1 rounded">public/houses/listings.json</code> in the
              project.
            </li>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        >
          <Download className="w-5 h-5" /> Export listings.json
        </button>
        <button
          type="button"
      ...
      <p className="text-sm text-gray-500 mt-8">
        Admin PIN is set via <code className="bg-gray-100 px-1 rounded">VITE_BLOG_ADMIN_PIN</code>{' '}
        in your environment (default: fastin2026). Same PIN as the blog CMS.
      </p>
    </div>
  );
}
