...
export default function HomePage() {
    ...
    // At the top of your component, update the state
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            setCurrentImageSlide((prev) => {
                // Move to next slide, but reset to 0 when we've gone through all original images
                const nextSlide = prev + 1;
                // Reset when we've shown all the original images once
                return nextSlide >= galleryImages.length ? 0 : nextSlide;
            });
        }, 3000); // Pause for 3 seconds on each set of 3 images
    ...
    const imageWidth = 800; // Match your CSS width
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            {/* NEW: Auto-Scrolling Image Gallery Section */}
            <section className="py-16 bg-gray-50 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
                    <div className="text-center">
                        <div className="inline-flex items-center gap-2 bg-yellow-100 rounded-full px-4 py-2 mb-4">
                            ...
                            <span className="text-yellow-700 text-sm font-semibold">Our Portfolio</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-bold text-blue-900 mb-4">Featured Properties</h2>
                ...
                <div className="relative overflow-hidden">
                    ...
                    {/* Scrolling container - always shows exactly 3 images */}
                    <div
                    ...
                    >
                        {/* Triple the images to ensure we always have 3 visible with wrapping */}
