...
export default function Navbar() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-24">
                ...
                <nav className="hidden lg:flex items-center space-x-1 xl:space-x-2">
                    <a
                        href="/"
                        className={`relative px-5 py-2.5 text-xs font-bold tracking-widest transition-all duration-300 rounded-lg group uppercase ${
                            location.pathname === "/"
                    ...
                    <div className="relative group">
                        <button
                            ...
                            className={`px-5 py-2.5 text-xs font-bold tracking-widest transition-all duration-300 rounded-lg flex items-center gap-2 group uppercase ${
                        ...
                        >
                            ...
                            <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-500 ${
                                activeDropdown === 'services' ? 'rotate-180 text-yellow-500' : ''
                            }`} />
                            {location.pathname.startsWith("/services") && (
                                <div className="absolute bottom-[-1.5rem] left-0 w-full h-1 bg-yellow-500 rounded-full"></div>
                            )}
                        ...
                        {/* Services Mega Menu */}
                        <div
                            className={`absolute top-full left-1/2 -translate-x-32 pt-5 w-[900px] bg-transparent transition-all duration-500 overflow-hidden ${
                    ...
                    <div className="relative group">
                        ...
                        >
                            ABOUT
                            <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-500 ${
                                activeDropdown === 'about' ? 'rotate-180 text-yellow-500' : ''
                            }`} />
                            {location.pathname.startsWith("/about") && (
                                <div className="absolute bottom-[-1.5rem] left-0 w-full h-1 bg-yellow-500 rounded-full"></div>
                            )}
                        ...
                        {/* About Mega Menu */}
                        <div
                            className={`absolute top-full left-1/2 -translate-x-1/2 pt-5 w-[1000px] bg-transparent transition-all duration-500 overflow-hidden ${
    ...
    <div className="relative group">
        ...
        >
            FRANCHISING
            <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-500 ${
                activeDropdown === 'franchising' ? 'rotate-180 text-yellow-500' : ''
            }`} />
            {location.pathname.startsWith("/franchising") && (
                <div className="absolute bottom-[-1.5rem] left-0 w-full h-1 bg-yellow-500 rounded-full"></div>
            )}
        ...
        <div
            className={`absolute top-full right-0 pt-5 w-80 bg-transparent transition-all duration-500 overflow-hidden ${
                ...
                <div className="grid grid-cols-1 gap-3">
                    {navItems.map((item) => (
                        <a
                            key={item.name}
                            href={item.href}
                            className={`block py-4 px-6 rounded-2xl font-bold tracking-widest text-xs uppercase transition-all ${
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        ...
                        <div className="space-y-1">
                            <button
                                ...
                                className={`w-full flex justify-between items-center py-4 px-6 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all ${
                                    activeDropdown === "services" ? "bg-yellow-400 text-blue-950 shadow-lg shadow-yellow-400/20" : "bg-gray-50 text-blue-950"
                                }`}
                            >
                        ...
                        <div className="space-y-1">
                            <button
                                ...
                                className={`w-full flex justify-between items-center py-4 px-6 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all ${
                                    activeDropdown === "about" ? "bg-yellow-400 text-blue-950 shadow-lg shadow-yellow-400/20" : "bg-gray-50 text-blue-950"
                                }`}
                            >
                        ...
                        <div className="space-y-1">
                            <button
                                ...
                                className={`w-full flex justify-between items-center py-4 px-6 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all ${
                                    activeDropdown === "franchising" ? "bg-yellow-400 text-blue-950 shadow-lg shadow-yellow-400/20" : "bg-gray-50 text-blue-950"
                                }`}
                            >
